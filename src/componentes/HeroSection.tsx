...
export const HeroSection = () => {
  return (
    <section className="h-[37.5rem] bg-cover bg-center flex flex-row justify-between items-center px-12 mt-16 bg-purple-100">
      <div className="text-left">
        ...
        <a href="#">
          {" "}
          <button className="mt-8 px-8 py-4 bg-orange-500 text-white text-lg font-semibold rounded hover:bg-orange-600 transition duration-300">
            Comece Agora
          </button>
        </a>
      </div>
